...
export default function HelpScreen() {
  ...
  const countries = [
    ...new Set(emergencyContacts.map((contact) => contact.country))
  ]
    ...
    <div className="p-4 space-y-6">
      ...
      <div className="text-center">
        ...
        <p className="text-gray-600 text-sm mt-1">
          Recursos de apoyo cuando más los necesites
        </p>
      </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-red-700 text-sm leading-relaxed">
              Si estás en crisis o tienes pensamientos de autolesión, contacta
              inmediatamente a los servicios de emergencia o las líneas de ayuda
      ...
      <Card className="p-6 bg-emerald-50 border-emerald-100 text-center">
        ...
        <p className="text-emerald-700 text-sm leading-relaxed">
          Buscar ayuda profesional es un acto de valentía y autocuidado. No
          estás solo/a en este camino. Hay personas capacitadas y dispuestas a
          acompañarte hacia el bienestar.
        </p>
      </Card>
    </div>
  )
