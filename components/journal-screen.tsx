  ...
  return (
    <div className="p-4 space-y-6">
      ...
      <div className="text-center">
        ...
        <h2 className="text-2xl font-semibold text-gray-800">Bitácora Emocional</h2>
        <p className="text-gray-600 text-sm mt-1">Registra cómo te sientes hoy</p>
      </div>
      ...
      <Card className="p-6 bg-white border-purple-100 shadow-sm">
        ...
        {/* Mood Selection */}
        <div className="mb-6">
          <p className="text-sm font-medium text-gray-700 mb-3">¿Cómo te sientes?</p>
        ...
        {/* Note */}
        <div className="mb-6">
          <p className="text-sm font-medium text-gray-700 mb-2">Notas libres (opcional)</p>
          <Textarea
            value={note}
            ...
            maxLength={500}
          />
          <p className="text-xs text-gray-500 mt-1">{note.length}/500 caracteres</p>
        </div>
        ...
        <div className="space-y-4">
          ...
          {entries.length === 0 ? (
            <Card className="p-6 text-center bg-purple-50 border-purple-100">
              <p className="text-purple-700">Aún no tienes entradas guardadas</p>
              <p className="text-purple-600 text-sm mt-1">¡Comienza registrando cómo te sientes hoy!</p>
            </Card>
          ) : (
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">
                          Estado: {moodOptions.find((m) => m.value === entry.mood)?.label}
                        </p>
                      </div>
                    </div>
                  </div>
