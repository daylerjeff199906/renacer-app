      ...
      <div className="p-4 space-y-6">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 text-sm mt-1">
            Elige una práctica para tu momento presente
          </p>
        </div>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-600 text-sm">
                  Momentos de mindfulness guiado
                </p>
              </div>
            </div>
          </Card>
          ...
          {breathingActive ? (
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Inhala por 4 segundos, mantén por 7, exhala por 8. Esta técnica
                ayuda a reducir la ansiedad y promover la calma.
              </p>
              <Button
      ...
      <div className="p-4 space-y-6">
        ...
        <Card className="p-4 bg-purple-50 border-purple-100">
          <p className="text-purple-800 text-sm text-center">
            💜 Repite cada afirmación en voz alta o mentalmente. Permítete
            sentir su verdad.
          </p>
        </Card>
      </div>
      ...
      <div className="p-4 space-y-6">
        ...
        <Card className="p-4 bg-indigo-50 border-indigo-100">
          <p className="text-indigo-800 text-sm text-center">
            🧘‍♀️ Encuentra un lugar cómodo y tranquilo. Estas meditaciones te
            guiarán paso a paso.
          </p>
        </Card>
      </div>
